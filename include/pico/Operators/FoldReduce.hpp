...
class FoldReduce : public UnaryOperator<In, Out> {
 public:
   ...
   */
  std::string name_short() { return "FoldReduce"; }

 protected:
  FoldReduce<In, Out, State>* clone() { return new FoldReduce(*this); }

  const OpClass operator_class() { return OpClass::FOLDREDUCE; }
